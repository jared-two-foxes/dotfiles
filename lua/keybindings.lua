...
function M.setup()
  ...
  require("which-key").register({
    ["<leader>"] = {
      a = { name = "Annotations", g = { "<cmd>lua require('neogen').generate()<cr>", "Generate Documentation" } },
      b = {
        name = "Buffer",
      ...
      d = {
        ...
        l = {
          "<cmd>CMakeClose<cr><cmd>lua require'dap.ext.vscode'.load_launchjs(nil, { cpp = {'c', 'cpp', 'python'} })<cr><cmd>lua require'dap'.continue()<cr>",
