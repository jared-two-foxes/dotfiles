...
Write .tdd-plan.md at the workspace root in this exact format:
...
- Acceptance criteria used (count, source: ticket)
- Edge cases (count, and whether sourced from .updated-plan.md)
- Complexity estimate
- Suggested next step: hand off to the test prompt
...
- Never write .tdd-plan.md without at least one acceptance criterion
