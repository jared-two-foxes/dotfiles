...
empty-criteria form in Step 5 below.
...
except the one-line "why" comment per retained criterion. The caller
writes this text verbatim to `.gap-plan.md`.
...
- [ ] [specific, testable criterion] <!-- why: one-line reason it's not yet satisfied -->
